...
const Support = () => {
    const [activate, setActivate]= useState('Support')
  return (
    <Box className='dashboard'>
        ...
        <Grid container columns={{xs:3, sm:8, md:12}} spacing={2} sx={{fontSize:'14px',
         justifyContent:'space-between'}}>
            ...
            <Grid item xs={1} >
                <Link to='/support' style={{display:'flex', position:'relative', alignItems:'center', color:'#333'}}
        ...
        <Typography sx={{marginLeft:'3rem', fontFamily:'Work Sans'}} gutterBottom>Support</Typography>
        </Box>
    </Box>
  )
}
