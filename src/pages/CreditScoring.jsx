...
const CreditScoring = () => {
    const [activate, setActivate]= useState('Credit')
  return (
    <Box sx={{}}>
        <PrimarySearchAppBar/>
        ...
        <Grid container columns={{xs:3, sm:8, md:12}} spacing={2} sx={{fontSize:'14px',
         justifyContent:'space-between'}}>
            ...
            <Grid item xs={1} >
                <Link to='/pipeline' style={{display:'flex', alignItems:'center', color:'#333'}}
            ...
            <Grid item xs={3} >
                <Link to='/credit-scoring' style={{display:'flex', position:'relative', alignItems:'center', color:'#333'}} 
        ...
        <Typography sx={{marginLeft:'3rem', fontFamily:'Work Sans'}} gutterBottom>
            Credit Scoring & Risk Management</Typography>
        </Box>
    </Box>
  )
}
