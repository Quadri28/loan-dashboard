...
const Report = () => {
    const [activate, setActivate]= useState('Report')
  return (
    <Box className='dashboard'>
        ...
        <Grid container columns={{xs:3, sm:8, md:12}} spacing={2} sx={{fontSize:'14px',
         justifyContent: 'space-between'}}>
            ...
            <Grid item xs={2} md={1}>
                <Link to='/reports' style={{display:'flex', position:'relative', alignItems:'center', color:'#333'}}
        ...
        <Typography sx={{marginLeft:'3rem'}} gutterBottom>Reports</Typography>
        </Box>
    </Box>
  )
}
